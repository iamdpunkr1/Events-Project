...
const YTVideos = () => {
  return (
    <div className=" w-full bg-white relative py-28 overflow-hidden">
       <div className='absolute bg-red-500 h-96 w-96 rounded-full z-1 blur-2xl -right-20 top-10 opacity-50'></div>
        <div className='absolute bg-red-500 h-96 w-96 rounded-full z-1 blur-2xl -left-40 -bottom-20 opacity-50'></div>
     
      <div className="max-w-[1200px] mx-auto py-8 ">
        <div className="text-center py-4 mt-8 z-10">
