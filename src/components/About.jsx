...
const About = () => {
  return (
    <section className="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-gray-900 ">
  <div className="justify-center flex-1 max-w-[1200px] py-4 mx-auto lg:py-6 md:px-6">
    ...
    <div className="flex flex-wrap ">
      ...
      <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
        <h2 className="py-3 pl-2 mb-4 text-2xl font-bold text-gray-700 border-l-4 border-red-500 dark:border-red-500 dark:text-gray-300">
        ...
        <ul className="mb-10">
          <li className="flex items-center mb-4 text-base text-gray-600 dark:text-gray-400">
            <span className="mr-3 text-red-500 dark:text-red-500 ">
              <svg
        ...
        <a
          href="#"
          className="px-4 py-3 text-red-700 transition-all transform border border-red-500 hover:bg-red-600 dark:border-red-00 dark:hover:bg-red-500 dark:hover:text-gray-100 dark:hover:border-red-500 dark:text-red-500 hover:text-gray-100"
        >
          Discover more
        </a>
      </div>
