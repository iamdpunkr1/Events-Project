      ...
      <div className="max-w-[1200px] mx-auto py-24 px-4 flex justify-between ">
        ...
        <div className="w-3/12 pt-8 ">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
            <p className="text-sm text-gray-200">Chenikuthi, Kamrup Metro</p>
         ...
         {/* Phone */}
          ...
          <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8">
            ...
            <div>
            <p className="text-sm text-gray-200">+91 9954626488, 8876023458</p>
          ...
          <svg viewBox="0 0 24 24" fill="none" className="w-9 h-9">
            ...
            <div>
            <p className="text-sm text-gray-200">info@trendmms.com</p>
            </div>
          </div>
          </div>
        </div>
